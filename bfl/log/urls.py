...
urlpatterns = [
    ...
    path('cardio/duplicate/<int:pk>', views.c_workout_duplicate, name='duplicate-c-workout'),
    path('resistance/duplicate/<int:pk>', views.r_workout_duplicate, name='duplicate-r-workout'),
    path('weightlifting/duplicate/<int:pk>', views.wl_workout_duplicate, name='duplicate-wl-workout'),
